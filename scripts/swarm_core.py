...
KNOWN_REGRESSION_CASES: dict[str, tuple[str, ...]] = {
    "CURRENT_V6_PRODUCT": (
        ...
        "verify_each_robust_coin_candidate_in_canonical_max_budget",
        "verify_assembled_10x250_and_max_budget_non_regression",
    ...
    "COIN_IMPROVEMENT_AUDIT": (
        ...
        "verify_canonical_max_budget_is_followup_compatibility_not_search_objective",
        "verify_training_only_topk_and_holdout_validation_are_preserved",
        "verify_loss_cluster_and_stress_evidence_for_all_ten_coins",
        "verify_candidate_profile_hashes_match_between_10x250_and_max_budget",
