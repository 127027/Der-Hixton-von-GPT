# HIXTON V2 – historische Paperstrategie ab 02.09.2026
...
Historischer Status zu diesem Prüfzeitpunkt: `PAPER_ACTIVE`, `LIVE_BLOCKED`. Der Eigentümer hatte V2 mit `DEC-037` ausdrücklich als bislang besten Paperstand freigegeben. Die unveränderliche Versionskennung enthält weiterhin `RESEARCH-CANDIDATE`; sie wird für historische Nachvollziehbarkeit nicht umbenannt. Dieser Ordner überschreibt weder V1 noch alte Runs.
